...
var SendingParamComponent = (function () {
    function SendingParamComponent(httpService) {
        this.httpService = httpService;
        this.user = new user_1.User(); // данные вводимого пользователя
        this.done = false;
    }
    SendingParamComponent.prototype.submit = function (user) {
        var _this = this;
        this.httpService.postData(user)
            .subscribe(function (data) { _this.receivedUser = data; _this.done = true; });
    };
    return SendingParamComponent;
}());
SendingParamComponent = __decorate([
    core_1.Component({
        selector: 's-p',
...
exports.SendingParamComponent = SendingParamComponent;
//# sourceMappingURL=sending.param.component.js.map